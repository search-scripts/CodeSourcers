-- Money rebirth gems open source
...
local btn1 = createButton("مال و جواهر و إعادة ميلاد")
...
btn1.MouseButton1Click:Connect(function()
	...
	local remote = rs.Events.rebirth
	if isRunning then
		autoEvent = RunService.Heartbeat:Connect(function()
			pcall(function()
				remote:FireServer("تشغيل")
			end)
		end)
	else
		if autoEvent then
		...
		pcall(function()
			remote:FireServer("إيقاف")
		end)
	end
	btn1.Text = (isArabic and (isRunning and "✅ مال و جواهر و إعادة ميلاد" or "❌ مال و جواهر و إعادة ميلاد")) or (isRunning and "✅ Money and Rebirth Gems" or "❌ Money and Rebirth Gems")
end)

local function updateLanguage()
	if isArabic then
		btn1.Text = (isRunning and "✅ مال و جواهر و إعادة ميلاد" or "❌ مال و جواهر و إعادة ميلاد")
		langBtn.Text = "English"
		discordLabel.Text = "discord:1w69"
	else
		btn1.Text = (isRunning and "✅ Money and Rebirth Gems" or "❌ Money and Rebirth Gems")
		langBtn.Text = "عربي"
		discordLabel.Text = "discord:1w69"
	end
end
